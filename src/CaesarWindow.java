...
public class CaesarWindow extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    CaesarWindow frame = new CaesarWindow();
    ...
    public CaesarWindow() {
        ...
        JLabel lbl_Caesar = new JLabel("CAESAR CIPHER");
        lbl_Caesar.setFont(new Font("Tahoma", Font.PLAIN, 25));
        lbl_Caesar.setBounds(149, 11, 192, 53);
        ...
        btn_Encrypt.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    String ciphered = Caesar.encrypt(plaintext, key);
        ...
        btn_Decrypt.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		try{
                    ...
                    int key = Integer.parseInt(txt_Key.getText());
                    String deciphered = Caesar.decrypt(enText, key);
