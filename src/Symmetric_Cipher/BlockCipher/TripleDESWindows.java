...
public class TripleDESWindows extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                	TripleDESWindows frame = new TripleDESWindows();
    ...
    public TripleDESWindows() {
        ...
        JLabel lbl_Caesar = new JLabel("TRIPLE DES CIPHER");
        ...
        txt_Ciphered.setBounds(143, 246, 484, 105);
