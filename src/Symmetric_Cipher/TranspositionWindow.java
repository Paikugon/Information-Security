...
public class TranspositionWindow extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    TranspositionWindow frame = new TranspositionWindow();
    ...
    public TranspositionWindow() {
        ...
        JLabel lbl_Caesar = new JLabel("TRANSPOSITION CIPHER");
        ...
        btn_Encrypt.setBounds(32, 396, 106, 43);
        ...
        btn_Encrypt.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    String ciphered = TranspositionCipher.encrypt(plaintext, key);
        ...
        btn_Decrypt.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		try{
                    ...
                    String key = txt_Key.getText().toLowerCase();
                    String deciphered = TranspositionCipher.decrypt(enText, key);
